...
(() => {
  ...
  // Cap the longest stored edge. Lowered from 1200 so many full-bleed
  // slots can coexist in the single ~2MB sidecar without the later writes
  // silently failing at the host's write cap.
  const MAX_DIM = 900;
